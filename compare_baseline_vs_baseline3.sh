...
# 对比脚本：baseline_groups vs baseline3_groups
...
echo "================================================================"
echo "Comparing baseline_groups vs baseline3_groups"
...
if [ -f "closed_loop_results/baseline_groups_results_4clients.json" ]; then
    cp closed_loop_results/baseline_groups_results_4clients.json comparison_results/baseline_groups_baseline3.json
    echo "✓ Saved"
fi
...
echo ">>> ROUND 2: baseline3_groups configuration (6 random groups, physical cores only)"
echo "========================================================================/"
...
if [ -f "closed_loop_results/baseline3_groups_results_4clients.json" ]; then
    cp closed_loop_results/baseline3_groups_results_4clients.json comparison_results/baseline3_groups_baseline3.json
    echo "✓ Saved"
fi
