...
if __name__ == "__main__":
    # 处理0.2组
    process_comparison(
        base_file='base-0.2.json', 
        exp_file='exp-0.2.json', 
        output_file='comparison_result_0.2.csv'
    )

    # 处理0.5组
    process_comparison(
        base_file='base-0.5.json', 
        exp_file='exp-0.5.json', 
        output_file='comparison_result_0.5.csv'
    )