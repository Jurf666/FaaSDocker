...
# 对比脚本：baseline_groups vs task_groups
...
echo "================================================================"
echo "Comparing baseline_groups vs task_groups"
...
if [ -f "closed_loop_results/baseline_groups_results_4clients.json" ]; then
    cp closed_loop_results/baseline_groups_results_4clients.json comparison_results/baseline_groups_fresh.json
    echo "✓ Saved"
fi
...
# ==================== ROUND 2: task_groups ====================
echo ">>> ROUND 2: task_groups configuration (27 groups, no cross-core)"
echo "========================================================================/"
...
export TASK_GROUPS_FILE="task_groups.json"
export TEST_DURATION=300
python3 run_experiment_closed_loop_refactored.py

if [ -f "closed_loop_results/task_groups_results_4clients.json" ]; then
    cp closed_loop_results/task_groups_results_4clients.json comparison_results/task_groups_fresh.json
    echo "✓ Saved"
fi
